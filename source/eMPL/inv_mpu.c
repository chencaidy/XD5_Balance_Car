 ...
 * min(int a, int b)
 */
#if defined EMPL_TARGET_MK64F12
#include "imu.h"
#include "fsl_debug_console.h"
/* FreeRTOS kernel includes. */
#include "FreeRTOS.h"
#include "task.h"
#define i2c_write   Sensor_I2C_WriteRegister
#define i2c_read    Sensor_I2C_ReadRegister
#define delay_ms    vTaskDelay
#define get_ms      Sensor_GetTimeStamp
#define log_i       PRINTF
#define log_e       PRINTF
